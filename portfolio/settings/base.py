...
DATABASES = {
    'default': dj_database_url.config(default=get_env_variable('PORTFOLIO_DATABASE_URL')),
}
...
SECRET_KEY = get_env_variable('PORTFOLIO_SECRET_KEY')
...
STATICFILES_DIRS = (
    str(PROJECT_DIR.joinpath("portfolio", "static").resolve()),
)
...
TEMPLATE_DIRS = (
    str(PROJECT_DIR.joinpath("portfolio", "templates").resolve()),
)
...
RAVEN_CONFIG = {
    'dsn': get_env_variable('PORTFOLIO_SENTRY_DSN'),
}
